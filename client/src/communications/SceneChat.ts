...
function SetUpSceneChat(scene: Phaser.Scene) {
    ...
    scene.input.on('pointerdown', (pointer) => {
        ...
        if (scene.dialog && !scene.dialog.getBounds().contains(pointer.x, pointer.y)) {
...
// This function checks if the user is typing in an input or textarea, put at the top of the update method
// to stop other game logic from running if the user is typing
